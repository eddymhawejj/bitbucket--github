...
class TestRemapSubmoduleUrls:
    ...
    def test_remaps_fqdn_hostname_variant(self, mock_config):
        ...
        assert "git@gatehousesatcom.ghe.com:networks-ngsp/lib.git" in result
        assert "cph1-eud-rep001" not in result
    ...
    def test_ignores_already_github_urls(self, mock_config):
        ...
        assert "git@gatehousesatcom.ghe.com:networks-ngsp/bb_repo.git" in result
        assert "git@gatehousesatcom.ghe.com:networks-ngsp/gh_repo.git" in result
    ...
    def test_mixed_hostnames_all_resolved(self, mock_config):
        ...
        assert "git@gatehousesatcom.ghe.com:networks-ngsp/repo_a.git" in result
        assert "git@gatehousesatcom.ghe.com:networks-ngsp/repo_b.git" in result
        assert "cph1-eud-rep001" not in result
